...
def create_parameter_dict(n_H, n_Z, timestep, n_steps, x_bounds, y_bounds, root_cell = None, 
                          ...
                          walking_speed_Z = None, lonely_walk_speed_H = None, H_contr_flocking = None,flocking_factors = None, 
    ...
    Args:
        ...
        lonely_walk_speed_H(float) in [km/h]:
    ...
    lonely_walk_speed_H = 5.0 if lonely_walk_speed_H == None else lonely_walk_speed_H
    ...
    if not isinstance(lonely_walk_speed_H, float): raise(TypeError)
    ...
    return {"n_H": n_H,                          
            ...
            "lonely_walk_speed_H": lonely_walk_speed_H,
